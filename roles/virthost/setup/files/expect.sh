...
expect -c"
  ...
  expect \"root#\"
  send \"set interfaces irb unit 1 family inet address 192.0.2.250/24\r\"
  expect \"root#\"
  send \"set vlans default l3-interface irb.1\r\"
  expect \"root#\"
  send \"set interfaces xe-0/0/2 unit 0 family ethernet-switching vlan members default\r\"
  expect \"root#\"
  send \"set interfaces xe-0/0/3 unit 0 family ethernet-switching vlan members default\r\"
  expect \"root#\"
  send \"set interfaces xe-0/0/4 unit 0 family ethernet-switching vlan members default\r\"
  expect \"root#\"
  send \"set interfaces xe-0/0/5 unit 0 family ethernet-switching vlan members default\r\"
  expect \"root#\"
  send \"set interfaces xe-0/0/6 unit 0 family ethernet-switching vlan members default\r\"
  expect \"root#\"
